...
ListItem * MemoryManager::allocatePhysicalBlocks(enum AddressPoolType type, const int count)
{
...
void MemoryManager::releasePhysicalBlocks(enum AddressPoolType type, ListItem * block)
{
    if (type == AddressPoolType::KERNEL)
    {
